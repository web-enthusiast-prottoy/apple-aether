...
export default function AetherIphoneDrive() {
	...
	// ── Main Controller ───────────────────────────────────────────────
	useEffect(() => {
		if (!isInView || !containerRef.current || isMobile) {
	...
	return (
      ...
      `}</style>
			...
			{/* Bottom Left Stats Cluster */}
			<div className="absolute bottom-8 left-8 z-20 pointer-events-none font-sans flex flex-col gap-3 w-max">
				{/* Accidents Avoided Counter */}
				<div className="bg-[#1c1c1e]/70 backdrop-blur-3xl border border-white/10 px-5 py-2.5 rounded-[24px] shadow-2xl transition-all duration-700 flex items-center gap-5 w-fit">
				...
				<div className="flex gap-2">
					<div className="bg-[#1c1c1e]/70 backdrop-blur-3xl border border-white/10 rounded-2xl px-4 py-2.5 min-w-[90px]">
			...
			{/* Desktop-Only Message — Fun Apple Aesthetic */}
			{isMobile && isInView && (
				<div
					className="absolute inset-0 z-[110] flex flex-col items-center justify-center bg-black/95 backdrop-blur-3xl px-8 text-center"
					style={{ fontFamily: '"Inter", -apple-system, system-ui, sans-serif' }}
				>
					<div className="relative w-24 h-24 mb-10 animate-pulse">
						{/* Stylized Laptop/Desktop Icon */}
						<div className="absolute inset-0 border-[3px] border-white/20 rounded-xl" />
						<div className="absolute top-2 left-2 right-2 bottom-6 border-[1.5px] border-white/10 rounded-sm bg-white/5" />
						<div className="absolute bottom-1 left-1/2 -translate-x-1/2 w-8 h-1 bg-white/20 rounded-full" />
						<div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-4 h-4 border-l-[3px] border-r-[3px] border-white/10" />
						<div className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-12 h-[3px] bg-white/20 rounded-full" />
						
						{/* Mobile Phone Icon with Slash */}
						<div className="absolute -top-4 -right-4 w-12 h-12 bg-[#0071e3] rounded-full flex items-center justify-center border-4 border-black">
							<div className="w-5 h-8 border-2 border-white/80 rounded-md relative">
								<div className="absolute top-1 left-1/2 -translate-x-1/2 w-2 h-[1px] bg-white/40" />
								<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-[2px] bg-white rotate-45" />
							</div>
						</div>
					</div>

					<h2 className="text-white text-xl sm:text-2xl font-semibold tracking-tight mb-4 px-2">
						Performance requires a bigger lane.
					</h2>
					<p className="text-white/60 text-[14px] sm:text-[15px] font-light leading-relaxed max-w-[280px] sm:max-w-sm mb-8">
						Your device is sharp, but the Aether Driving Simulation needs the power of a desktop screen to fully engage its neural core.
					</p>
					<div className="flex flex-col items-center gap-4">
						<div className="px-6 py-2.5 rounded-full bg-white text-black text-[12px] sm:text-[13px] font-medium tracking-wide">
							Visit on Desktop to Drive
						</div>
						<p className="text-white/30 text-[9px] sm:text-[10px] uppercase tracking-[0.2em] font-medium">
							Optimized for Safari, Chrome & Edge
						</p>
					</div>
				</div>
			)}
					...
					<div className="relative flex flex-col items-center">
						...
						<div className="relative w-48 h-48 flex items-center justify-center">
							<svg className="w-full h-full transform -rotate-90">
								...
								<circle
									...
									strokeDasharray="502"
									style={{
										strokeDashoffset: 502 - (502 * loadProgress) / 100,
							...
							<div className="absolute inset-0 flex flex-col items-center justify-center">
								<div className="text-white text-[42px] font-extralight tracking-tight tabular-nums mb-1">
									{Math.round(loadProgress)}
								</div>
								<div className="text-white/20 text-[9px] font-semibold tracking-[0.4em] uppercase">
									Percent
								</div>
							</div>
						</div>
						...
						<div className="mt-16 flex flex-col items-center gap-4">
							<div className="flex items-center gap-4">
								<div className="h-[1px] w-12 bg-gradient-to-l from-white/25 to-transparent" />
								<h2 className="text-white font-semibold tracking-[0.4em] text-[11px] uppercase">
									Aether Drive
								</h2>
								<div className="h-[1px] w-12 bg-gradient-to-r from-white/25 to-transparent" />
							</div>
							<p className="text-white/45 text-[12px] font-light tracking-wide italic">
