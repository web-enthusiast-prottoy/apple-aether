...
interface AetherHeroAlternativeProps {
  isParentLoading?: boolean;
}

export default function AetherHeroAlternative({ isParentLoading = false }: AetherHeroAlternativeProps) {
  ...
  return (
    <section ref={sectionRef} className="hero-v2-alt" id="overview" aria-label="Apple Aether Hero">
      <canvas 
        ref={canvasRef} 
        className="hero-v2-alt__canvas" 
        style={{ width: "100%", height: "100%", display: "block" }}
      />

      <div className="hero-v2-alt__words" aria-hidden="true">
        <span ref={textLeftRef} className="hero-v2-alt__word hero-v2-alt__word--left">
          Apple
        </span>
        <span ref={textRightRef} className="hero-v2-alt__word hero-v2-alt__word--right">
          Aether
        </span>
      </div>
    </section>
